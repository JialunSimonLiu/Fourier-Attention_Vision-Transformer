...
parser.add_argument('--input', type=str, default="gt_dp_mag_1.tif", help='Input magnitude .tif, normalized here to [0,1]')
...
# === Noise Levels (fixed) ===
noise_levels = [
    {"label": "low",      "poisson_scale": 5000, "gauss_sigma": 0.0005, "partial_sigma": 0.4},
    {"label": "moderate", "poisson_scale": 2000, "gauss_sigma": 0.0010, "partial_sigma": 0.5},
    {"label": "strong",   "poisson_scale": 800,  "gauss_sigma": 0.0015, "partial_sigma": 0.55},
    {"label": "extreme",  "poisson_scale": 300,  "gauss_sigma": 0.0030, "partial_sigma": 0.65},
    {"label": "degraded", "poisson_scale": 100,  "gauss_sigma": 0.0050, "partial_sigma": 0.75},
]
